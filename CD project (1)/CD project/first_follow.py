...
class DFA:
    ...
    def render(self, filename='genratedDFA', format='png'):
...
#Ananya Endsssssssssssssss
######################################################################################################################



######################################################################################################################
#Parthhhhh Startssssss
class Terminal:
...
def main():
    ...
    global production_list, t_list, nt_list, dfa_string
    ctr=1
    with open("d:\coding\compiler_design\CD project\clr_grammar.txt") as f:
        lines = f.readlines()
        for line in lines:
            dfa_string += line
    with open("d:\coding\compiler_design\CD project\clr_grammar.txt") as f:
